...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(isset($_POST['submit'])){
        ...
        if(empty($name) || empty($email) || empty($subject) || empty($message)){
            ...
            echo "<div id='alert' class='alert alert-danger'>The message cannot be longer than 255 characters!</div>";
        } else if(!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            echo "<div id='alert' class='alert alert-danger'>Invalid email format!</div>";
        } else {
            $db->insertContact($name, $email, $subject, $message);
            echo "<div id='alert' class='alert alert-success'>Message sent successfully!</div>";
        }
    }
}
?>
                ...
                <div class="col-lg-8">
                    <form class="form-contact contact_form" action="" method="post" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button type="submit" class="button button-contactForm btn_1" name="submit">Send Message</button>
                                </div>
                            </div>
                        </div>
                    </form>
